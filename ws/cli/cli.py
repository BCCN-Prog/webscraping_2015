...
from ws.plugins_master import pandize_temporary_forecasts
...
def cli(argv):
    ...
    for opt, arg in opts:
        ...
        elif opt == '--pandize_temporary':
            pandize_temporary = True
